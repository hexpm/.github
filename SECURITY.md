...
[![Email Report](https://img.shields.io/badge/Email-security%40hex.pm-blue)][email]
...
If you believe you have found a security vulnerability in a hexpm repository,
please report it via [GitHub Security Vulnerability Reporting][github-private-vulnerability-reporting]
at `github.com/hexpm/<repository>/security/advisories/new`
or via email to [`security@hex.pm`][email] if that is more suitable for you.
...
We work together with the [Erlang Ecosystem Foundation (EEF) CNA][eef-cna] for
...
vulnerability management team at [`security@hex.pm`][email].
